...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/wildcat/state");
var engine = props.globals.getNode("sim/model/wildcat/engine");
...
var turbine = props.globals.getNode("sim/model/wildcat/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/wildcat/torque-pct", 1);
