...
var fg = getprop("/sim/version/flightgear");
var model = getprop("/sim/model/fg-ver");


if (fg != model){
setprop("/fdm/jsbsim/simulation/wrg-ver",1);
window_lhb.write("WRONG FLIGHTGEAR VERSION");
window_lhb.write("YOU WANT FG : " ~ model);
}else{
setprop("/fdm/jsbsim/simulation/wrg-ver",0);
terrain_survol();
}
